package com.dn.helper.mybatisHelper.util;
...
import com.dn.helper.MyBatisHelper;
...
public class Util_ASOReader {
	 ...
	 * </ul>
	 */
	private static void init_annotionMapInfo() {
		//初始化注释信息map。
		FileReader f_annotion = new FileReader(MyBatisHelper.ANNOTION_MAP_FILE,true,"gbk");

...
public abstract class SexVOcreator {
	...
	protected Collection<? extends String> _createClassAnnotation() {
		...
		l.add(" * <li>");
		l.add(" * ");
		l.add(" *                        ---- " + SexGameConf.AUTHOR + "  " + new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
		l.add(" * </li>");
		l.add(" * </p>");
		l.add(" * ");
		...
		l.add(" * </p>");
		l.add(" */");
		if(this.className != null && this.className.endsWith(SexGameConf.RESPONSEVO)){
	...
	protected void checkType() {
		for(String i : this.typeList){
			if(SexGameConf.supportMap.get(i) == null)

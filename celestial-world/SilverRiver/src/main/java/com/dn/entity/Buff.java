...
public class Buff{
	...
	public boolean equals(Object obj) {
		...
		if (goodslevel == null) {
			...
			return false;
		if (buffKind == null) {
			if (other.buffKind != null)
				return false;
		} else if (!buffKind.equals(other.buffKind))
			return false;
		if (search == null) {
	...
	public int hashCode() {
		...
		result = prime * result + ((buffKind == null) ? 0 : buffKind.hashCode());
	 ...
	 * @param representId
	 */
	public Buff setRepresentId(String representId) {
	 ...
	 * @param suitId
	 */
	public Buff setSuitId(String suitId) {
		this.suitId = suitId;
		return this;
	}
	 ...
	 * @param level
	 */
	public Buff setLevel(Integer level) {
		this.level = level;
		return this;
	}
	 ...
	 * @param goodslevel
	 */
	public Buff setGoodslevel(String goodslevel) {
	 ...
	 * @param buffKind
	 */
	public Buff setBuffKind(String buffKind) {
	 ...
	 * @param search
	 */
	public Buff setSearch(String search) {
		this.search = search;
		return this;
	}
	 ...
	 * @param min
	 */
	public Buff setMin(Integer min) {
		this.min = min;
		return this;
	}
	 ...
	 * @param zhi
	 */
	public Buff setZhi(Integer zhi) {
		this.zhi = zhi;
		return this;
	}
	 ...
	 * @param xyDK
	 */
	public Buff setXyDK(Integer xyDK) {
		this.xyDK = xyDK;
		return this;
	}
	 ...
	 * @param zmDK
	 */
	public Buff setZmDK(Integer zmDK) {
		this.zmDK = zmDK;
		return this;
	}
	 ...
	 * @param yzDK
	 */
	public Buff setYzDK(Integer yzDK) {
		this.yzDK = yzDK;
		return this;
	}
	 ...
	 * @param zmsh
	 */
	public Buff setZmsh(Integer zmsh) {
		this.zmsh = zmsh;
		return this;
	}
	 ...
	 * @param ydsd
	 */
	public Buff setYdsd(Integer ydsd) {
		this.ydsd = ydsd;
		return this;
	}
	 ...
	 * @param mphf
	 */
	public Buff setMphf(Integer mphf) {
		this.mphf = mphf;
		return this;
	}
	 ...
	 * @param min_
	 */
	public Buff setMin_(Double min_) {
		this.min_ = min_;
		return this;
	}
	 ...
	 * @param zhi_
	 */
	public Buff setZhi_(Double zhi_) {
		this.zhi_ = zhi_;
		return this;
	}
	 ...
	 * @param xyDK_
	 */
	public Buff setXyDK_(Double xyDK_) {
		this.xyDK_ = xyDK_;
		return this;
	}
	 ...
	 * @param zmDK_
	 */
	public Buff setZmDK_(Double zmDK_) {
		this.zmDK_ = zmDK_;
		return this;
	}
	 ...
	 * @param yzDK_
	 */
	public Buff setYzDK_(Double yzDK_) {
		this.yzDK_ = yzDK_;
		return this;
	}
	 ...
	 * @param zmsh_
	 */
	public Buff setZmsh_(Double zmsh_) {
		this.zmsh_ = zmsh_;
		return this;
	}
	 ...
	 * @param ydsd_
	 */
	public Buff setYdsd_(Double ydsd_) {
		this.ydsd_ = ydsd_;
		return this;
	}
	 ...
	 * @param mphf_
	 */
	public Buff setMphf_(Double mphf_) {
		this.mphf_ = mphf_;
		return this;
	}

...
public class DragonJade{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DragonJade other = (DragonJade) obj;
		if (id == null) {
			if (other.id != null)
				return false;
		...
		if (goodslevel == null) {
			...
			return false;
		if (dragonJadeKind == null) {
			if (other.dragonJadeKind != null)
				return false;
		} else if (!dragonJadeKind.equals(other.dragonJadeKind))
			return false;
		if (search == null) {
	...
	public int hashCode() {
		...
		result = prime * result + ((dragonJadeKind == null) ? 0 : dragonJadeKind.hashCode());
	 ...
	 * @param id
	 */
	public DragonJade setId(Integer id) {
		this.id = id;
		return this;
	}
	 ...
	 * @param representId
	 */
	public DragonJade setRepresentId(String representId) {
	 ...
	 * @param suitId
	 */
	public DragonJade setSuitId(String suitId) {
		this.suitId = suitId;
		return this;
	}
	 ...
	 * @param name
	 */
	public DragonJade setName(String name) {
		this.name = name;
		return this;
	}
	 ...
	 * @param level
	 */
	public DragonJade setLevel(Integer level) {
		this.level = level;
		return this;
	}
	 ...
	 * @param goodslevel
	 */
	public DragonJade setGoodslevel(String goodslevel) {
	 ...
	 * @return
	 */
	public String getDragonJadeKind() {
		return dragonJadeKind ;
	}
	 ...
	 * 设置龙玉类型
	 * </ul>
	 * @param dragonJadeKind
	 */
	public DragonJade setDragonJadeKind(String dragonJadeKind) {
		this.dragonJadeKind = dragonJadeKind;
		return this;
	}
	 ...
	 * @param search
	 */
	public DragonJade setSearch(String search) {
		this.search = search;
		return this;
	}
	 ...
	 * @param li
	 */
	public DragonJade setLi(Integer li) {
		this.li = li;
		return this;
	}
	 ...
	 * @param min
	 */
	public DragonJade setMin(Integer min) {
		this.min = min;
		return this;
	}
	 ...
	 * @param zhi
	 */
	public DragonJade setZhi(Integer zhi) {
		this.zhi = zhi;
		return this;
	}
	 ...
	 * @param ti
	 */
	public DragonJade setTi(Integer ti) {
		this.ti = ti;
		return this;
	}
	 ...
	 * @param wg
	 */
	public DragonJade setWg(String wg) {
		this.wg = wg;
		return this;
	}
	 ...
	 * @param yz
	 */
	public DragonJade setYz(Integer yz) {
		this.yz = yz;
		return this;
	}
	 ...
	 * @param xy
	 */
	public DragonJade setXy(Integer xy) {
		this.xy = xy;
		return this;
	}
	 ...
	 * @param xyDK
	 */
	public DragonJade setXyDK(Integer xyDK) {
		this.xyDK = xyDK;
		return this;
	}
	 ...
	 * @param zm
	 */
	public DragonJade setZm(Integer zm) {
		this.zm = zm;
		return this;
	}
	 ...
	 * @param zmDK
	 */
	public DragonJade setZmDK(Integer zmDK) {
		this.zmDK = zmDK;
		return this;
	}
	 ...
	 * @param mg
	 */
	public DragonJade setMg(String mg) {
		this.mg = mg;
		return this;
	}
	 ...
	 * @param mf
	 */
	public DragonJade setMf(Integer mf) {
		this.mf = mf;
		return this;
	}
	 ...
	 * @param hp
	 */
	public DragonJade setHp(Integer hp) {
		this.hp = hp;
		return this;
	}
	 ...
	 * @param wf
	 */
	public DragonJade setWf(Integer wf) {
		this.wf = wf;
		return this;
	}
	 ...
	 * @param yzDK
	 */
	public DragonJade setYzDK(Integer yzDK) {
		this.yzDK = yzDK;
		return this;
	}
	 ...
	 * @param gg
	 */
	public DragonJade setGg(Double gg) {
		this.gg = gg;
		return this;
	}
	 ...
	 * @param hg
	 */
	public DragonJade setHg(Double hg) {
		this.hg = hg;
		return this;
	}
	 ...
	 * @param sg
	 */
	public DragonJade setSg(Double sg) {
		this.sg = sg;
		return this;
	}
	 ...
	 * @param ag
	 */
	public DragonJade setAg(Double ag) {
		this.ag = ag;
		return this;
	}
	 ...
	 * @param gf
	 */
	public DragonJade setGf(Double gf) {
		this.gf = gf;
		return this;
	}
	 ...
	 * @param hf
	 */
	public DragonJade setHf(Double hf) {
		this.hf = hf;
		return this;
	}
	 ...
	 * @param sf
	 */
	public DragonJade setSf(Double sf) {
		this.sf = sf;
		return this;
	}
	 ...
	 * @param af
	 */
	public DragonJade setAf(Double af) {
		this.af = af;
		return this;
	}
	 ...
	 * @param zz
	 */
	public DragonJade setZz(Integer zz) {
		this.zz = zz;
		return this;
	}
	 ...
	 * @param zmsh
	 */
	public DragonJade setZmsh(Integer zmsh) {
		this.zmsh = zmsh;
		return this;
	}
	 ...
	 * @param ydsd
	 */
	public DragonJade setYdsd(Integer ydsd) {
		this.ydsd = ydsd;
		return this;
	}
	 ...
	 * @param mphf
	 */
	public DragonJade setMphf(Integer mphf) {
		this.mphf = mphf;
		return this;
	}
	 ...
	 * @param li_
	 */
	public DragonJade setLi_(Double li_) {
		this.li_ = li_;
		return this;
	}
	 ...
	 * @param min_
	 */
	public DragonJade setMin_(Double min_) {
		this.min_ = min_;
		return this;
	}
	 ...
	 * @param zhi_
	 */
	public DragonJade setZhi_(Double zhi_) {
		this.zhi_ = zhi_;
		return this;
	}
	 ...
	 * @param ti_
	 */
	public DragonJade setTi_(Double ti_) {
		this.ti_ = ti_;
		return this;
	}
	 ...
	 * @param wg_
	 */
	public DragonJade setWg_(String wg_) {
		this.wg_ = wg_;
		return this;
	}
	 ...
	 * @param yz_
	 */
	public DragonJade setYz_(Double yz_) {
		this.yz_ = yz_;
		return this;
	}
	 ...
	 * @param xy_
	 */
	public DragonJade setXy_(Double xy_) {
		this.xy_ = xy_;
		return this;
	}
	 ...
	 * @param xyDK_
	 */
	public DragonJade setXyDK_(Double xyDK_) {
		this.xyDK_ = xyDK_;
		return this;
	}
	 ...
	 * @param zm_
	 */
	public DragonJade setZm_(Double zm_) {
		this.zm_ = zm_;
		return this;
	}
	 ...
	 * @param zmDK_
	 */
	public DragonJade setZmDK_(Double zmDK_) {
		this.zmDK_ = zmDK_;
		return this;
	}
	 ...
	 * @param mg_
	 */
	public DragonJade setMg_(String mg_) {
		this.mg_ = mg_;
		return this;
	}
	 ...
	 * @param mf_
	 */
	public DragonJade setMf_(Double mf_) {
		this.mf_ = mf_;
		return this;
	}
	 ...
	 * @param hp_
	 */
	public DragonJade setHp_(Double hp_) {
		this.hp_ = hp_;
		return this;
	}
	 ...
	 * @param wf_
	 */
	public DragonJade setWf_(Double wf_) {
		this.wf_ = wf_;
		return this;
	}
	 ...
	 * @param yzDK_
	 */
	public DragonJade setYzDK_(Double yzDK_) {
		this.yzDK_ = yzDK_;
		return this;
	}
	 ...
	 * @param zz_
	 */
	public DragonJade setZz_(Double zz_) {
		this.zz_ = zz_;
		return this;
	}
	 ...
	 * @param zmsh_
	 */
	public DragonJade setZmsh_(Double zmsh_) {
		this.zmsh_ = zmsh_;
		return this;
	}
	 ...
	 * @param ydsd_
	 */
	public DragonJade setYdsd_(Double ydsd_) {
		this.ydsd_ = ydsd_;
		return this;
	}
	 ...
	 * @param mphf_
	 */
	public DragonJade setMphf_(Double mphf_) {
		this.mphf_ = mphf_;
		return this;
	}

...
import com.celestial.butterflystorm.dragonNest.Interface.Equipment;
import com.celestial.butterflystorm.dragonNest.impl.EquipmentImpl;
import com.celestial.butterflystorm.dragonNest.other.Config;

public class TestEquipment extends TestCase {
	String path = "src/com/dragonNest/other/equipment/²ÓÀÃµÄ°¢¶û½ÜËþ½äÖ¸/²ÓÀÃµÄ°¢¶û½ÜËþ½äÖ¸.txt";

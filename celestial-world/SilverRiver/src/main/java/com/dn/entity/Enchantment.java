...
public class Enchantment{
	 ...
	 * 附魔类型 
	 */
	private String enchantmentKind ;
	/**
	 * 条件搜索字段用于实现递归数据结构 
	 */
	...
	public boolean equals(Object obj) {
		...
		if (goodslevel == null) {
			...
			return false;
		if (enchantmentKind == null) {
			if (other.enchantmentKind != null)
				return false;
		} else if (!enchantmentKind.equals(other.enchantmentKind))
			return false;
		if (search == null) {
	...
	public int hashCode() {
		...
		result = prime * result + ((enchantmentKind == null) ? 0 : enchantmentKind.hashCode());
	...
	public String toString() {
		return "Enchantment ["
				...
				+" enchantmentKind=" + enchantmentKind + ", "
				+" search=" + search + ", "
				+" li=" + li + ", "
				+" min=" + min + ", "
				+" zhi=" + zhi + ", "
	 ...
	 * @param id
	 */
	public Enchantment setId(Integer id) {
		this.id = id;
		return this;
	}
	 ...
	 * @param representId
	 */
	public Enchantment setRepresentId(String representId) {
	 ...
	 * @param suitId
	 */
	public Enchantment setSuitId(String suitId) {
		this.suitId = suitId;
		return this;
	}
	 ...
	 * @param level
	 */
	public Enchantment setLevel(Integer level) {
		this.level = level;
		return this;
	}
	 ...
	 * @param goodslevel
	 */
	public Enchantment setGoodslevel(String goodslevel) {
	 ...
	 * @return
	 */
	public String getEnchantmentKind() {
	 ...
	 * 设置附魔类型
	 * </ul>
	 * @param enchantmentKind
	 */
	public Enchantment setEnchantmentKind(String enchantmentKind) {
		this.enchantmentKind = enchantmentKind;
		return this;
	}
	 ...
	 * @param search
	 */
	public Enchantment setSearch(String search) {
		this.search = search;
		return this;
	}
	 ...
	 * @param li
	 */
	public Enchantment setLi(Integer li) {
		this.li = li;
		return this;
	}
	 ...
	 * @param min
	 */
	public Enchantment setMin(Integer min) {
		this.min = min;
		return this;
	}
	 ...
	 * @param zhi
	 */
	public Enchantment setZhi(Integer zhi) {
		this.zhi = zhi;
		return this;
	}
	 ...
	 * @param ti
	 */
	public Enchantment setTi(Integer ti) {
		this.ti = ti;
		return this;
	}
	 ...
	 * @param wg
	 */
	public Enchantment setWg(String wg) {
		this.wg = wg;
		return this;
	}
	 ...
	 * @param yz
	 */
	public Enchantment setYz(Integer yz) {
		this.yz = yz;
		return this;
	}
	 ...
	 * @param xy
	 */
	public Enchantment setXy(Integer xy) {
		this.xy = xy;
		return this;
	}
	 ...
	 * @param xyDK
	 */
	public Enchantment setXyDK(Integer xyDK) {
		this.xyDK = xyDK;
		return this;
	}
	 ...
	 * @param zm
	 */
	public Enchantment setZm(Integer zm) {
		this.zm = zm;
		return this;
	}
	 ...
	 * @param zmDK
	 */
	public Enchantment setZmDK(Integer zmDK) {
		this.zmDK = zmDK;
		return this;
	}
	 ...
	 * @param mg
	 */
	public Enchantment setMg(String mg) {
		this.mg = mg;
		return this;
	}
	 ...
	 * @param mf
	 */
	public Enchantment setMf(Integer mf) {
		this.mf = mf;
		return this;
	}
	 ...
	 * @param hp
	 */
	public Enchantment setHp(Integer hp) {
		this.hp = hp;
		return this;
	}
	 ...
	 * @param wf
	 */
	public Enchantment setWf(Integer wf) {
		this.wf = wf;
		return this;
	}
	 ...
	 * @param yzDK
	 */
	public Enchantment setYzDK(Integer yzDK) {
		this.yzDK = yzDK;
		return this;
	}
	 ...
	 * @param gg
	 */
	public Enchantment setGg(Double gg) {
		this.gg = gg;
		return this;
	}
	 ...
	 * @param hg
	 */
	public Enchantment setHg(Double hg) {
		this.hg = hg;
		return this;
	}
	 ...
	 * @param sg
	 */
	public Enchantment setSg(Double sg) {
		this.sg = sg;
		return this;
	}
	 ...
	 * @param ag
	 */
	public Enchantment setAg(Double ag) {
		this.ag = ag;
		return this;
	}
	 ...
	 * @param gf
	 */
	public Enchantment setGf(Double gf) {
		this.gf = gf;
		return this;
	}
	 ...
	 * @param hf
	 */
	public Enchantment setHf(Double hf) {
		this.hf = hf;
		return this;
	}
	 ...
	 * @param sf
	 */
	public Enchantment setSf(Double sf) {
		this.sf = sf;
		return this;
	}
	 ...
	 * @param af
	 */
	public Enchantment setAf(Double af) {
		this.af = af;
		return this;
	}
	 ...
	 * @param zz
	 */
	public Enchantment setZz(Integer zz) {
		this.zz = zz;
		return this;
	}
	 ...
	 * @param zmsh
	 */
	public Enchantment setZmsh(Integer zmsh) {
		this.zmsh = zmsh;
		return this;
	}
	 ...
	 * @param ydsd
	 */
	public Enchantment setYdsd(Integer ydsd) {
		this.ydsd = ydsd;
		return this;
	}
	 ...
	 * @param mphf
	 */
	public Enchantment setMphf(Integer mphf) {
		this.mphf = mphf;
		return this;
	}
	 ...
	 * @param li_
	 */
	public Enchantment setLi_(Double li_) {
		this.li_ = li_;
		return this;
	}
	 ...
	 * @param min_
	 */
	public Enchantment setMin_(Double min_) {
		this.min_ = min_;
		return this;
	}
	 ...
	 * @param zhi_
	 */
	public Enchantment setZhi_(Double zhi_) {
		this.zhi_ = zhi_;
		return this;
	}
	 ...
	 * @param ti_
	 */
	public Enchantment setTi_(Double ti_) {
		this.ti_ = ti_;
		return this;
	}
	 ...
	 * @param wg_
	 */
	public Enchantment setWg_(String wg_) {
		this.wg_ = wg_;
		return this;
	}
	 ...
	 * @param yz_
	 */
	public Enchantment setYz_(Double yz_) {
		this.yz_ = yz_;
		return this;
	}
	 ...
	 * @param xy_
	 */
	public Enchantment setXy_(Double xy_) {
		this.xy_ = xy_;
		return this;
	}
	 ...
	 * @param xyDK_
	 */
	public Enchantment setXyDK_(Double xyDK_) {
		this.xyDK_ = xyDK_;
		return this;
	}
	 ...
	 * @param zm_
	 */
	public Enchantment setZm_(Double zm_) {
		this.zm_ = zm_;
		return this;
	}
	 ...
	 * @param zmDK_
	 */
	public Enchantment setZmDK_(Double zmDK_) {
		this.zmDK_ = zmDK_;
		return this;
	}
	 ...
	 * @param mg_
	 */
	public Enchantment setMg_(String mg_) {
		this.mg_ = mg_;
		return this;
	}
	 ...
	 * @param mf_
	 */
	public Enchantment setMf_(Double mf_) {
		this.mf_ = mf_;
		return this;
	}
	 ...
	 * @param hp_
	 */
	public Enchantment setHp_(Double hp_) {
		this.hp_ = hp_;
		return this;
	}
	 ...
	 * @param wf_
	 */
	public Enchantment setWf_(Double wf_) {
		this.wf_ = wf_;
		return this;
	}
	 ...
	 * @param yzDK_
	 */
	public Enchantment setYzDK_(Double yzDK_) {
		this.yzDK_ = yzDK_;
		return this;
	}
	 ...
	 * @param zz_
	 */
	public Enchantment setZz_(Double zz_) {
		this.zz_ = zz_;
		return this;
	}
	 ...
	 * @param zmsh_
	 */
	public Enchantment setZmsh_(Double zmsh_) {
		this.zmsh_ = zmsh_;
		return this;
	}
	 ...
	 * @param ydsd_
	 */
	public Enchantment setYdsd_(Double ydsd_) {
		this.ydsd_ = ydsd_;
		return this;
	}
	 ...
	 * @param mphf_
	 */
	public Enchantment setMphf_(Double mphf_) {
		this.mphf_ = mphf_;
		return this;
	}

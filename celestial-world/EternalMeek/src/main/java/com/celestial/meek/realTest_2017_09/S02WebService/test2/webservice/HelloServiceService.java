 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://test2.S02WebService.realTest_2017_09.meek.celestial.com/", wsdlLocation = "http://localhost:8080/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://test2.S02WebService.realTest_2017_09.meek.celestial.com/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://test2.S02WebService.realTest_2017_09.meek.celestial.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test2.S02WebService.realTest_2017_09.meek.celestial.com/", "HelloServicePort"), HelloService.class, features);
    }
